...
const PeerFeedbackForm = () => {
  // =========================
  // Состояние формы: массив респондентов
  // Каждый респондент содержит поля: id, name, taskFeedback, qualities, interaction, improvement
  // =========================
  ...
  // =========================
  // Функция для изменения данных респондента
  // =========================
  ...
  // =========================
  // Добавление нового респондента в форму
  // =========================
  const addRespondent = () => {
    setRespondents(prev => [
      ...prev,
      { id: prev.length + 1, name: '', taskFeedback: '', qualities: '', interaction: 0, improvement: '' }
    ]);
  };
  ...
  return (
    <div className={styles.formBlock}>
      ...
      {/* =========================
          Перебор всех респондентов и отрисовка их полей
          ========================= */}
      ...
      {/* =========================
          Кнопка добавления нового респондента
          ========================= */}
